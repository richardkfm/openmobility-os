...
### Changed
- CONTRIBUTING.md now documents the shell-specific virtualenv activation
  commands (fish, csh, PowerShell) alongside the bash/zsh form, so
  non-bash contributors don't trip over the default `source venv/bin/activate`
