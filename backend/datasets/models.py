...
class DataSource(models.Model):
    ...
    class LayerKind(models.TextChoices):
        ...
        STREET_PARKING = "street_parking", _("Kerbside / on-street parking")
        CAR_LANES = "car_lanes", _("Motor-traffic lanes and widths")
        OBSTACLES = "obstacles", _("Physical obstacles in the street profile")
        PARKING_LOTS = "parking_lots", _("Off-street parking areas")
        FOOTWAYS = "footways", _("Footways and sidewalks")
        PEDESTRIAN_CROSSINGS = "pedestrian_crossings", _("Pedestrian crossings")
